                     ...
                     <ul class="slds-global-header__item slds-grid slds-grid_vertical-align-center">
                           <li class="slds-grid">
                              <div class="slds-global-header__logo">
								<img src="../../resources/assets/images/logo.svg" alt="Smiley face" height="30" width="30">
					 </div>
                           </li>
                     ...
                     <div aria-expanded="false" aria-haspopup="listbox" class="slds-form-element slds-lookup" role="combobox">
                        ...
                        <ul class="slds-global-header__item slds-grid slds-grid_vertical-align-center">
                           <li class="slds-grid">
                              ...
                              <img src="../../resources/assets/icons/utility/favorite_60.png" alt="Smiley face" height="17" width="17">
                           ...
                           <li class="slds-dropdown-trigger slds-dropdown-trigger_click">
                              ...
                              <img src="../../resources/assets/icons/utility/help_60.png" alt="Smiley face" height="17" width="17">
                           ...
                           <li class="slds-dropdown-trigger slds-dropdown-trigger_click">
                              ...
                              <img src="../../resources/assets/icons/utility/notification_60.png" alt="Smiley face" height="17" width="17">
                           ...
                           <li class="slds-dropdown-trigger slds-dropdown-trigger_click slds-m-left_x-small">
                              ...
                              <img alt="Person name" src="../../resources/assets/images/avatar2.jpg" title="User avatar">
                              </span>
                              </button>
                           </li>
						   ...
						   <li class="slds-dropdown-trigger slds-dropdown-trigger_click">
                              ...
                              <img src="../../resources/assets/icons/utility/logout_60.png" alt="Smiley face" height="17" width="17">
                              ...
                              <li class="slds-global-header__notification slds-p-around_xx-small slds-global-header__notification_unread">
                                 <div class="slds-media slds-has-flexi-truncate slds-p-around_x-small">
                                    <div class="slds-media__figure">
                                       ...
                                       <img alt="Kelly Chan" src="../../resources/assets/images/avatar3.jpg" title="Kelly Chan avatar">
                                       </span>
                                    </div>
                                       ...
                                       <div class="slds-grid slds-grid_align-spread">
                                          ...
                                          <div class="slds-no-flex slds-grid slds-grid_vertical">
                                             <div class="slds-dropdown-trigger slds-dropdown-trigger_click slds-is-open">
                                                ...
                                                <img src="../../resources/assets/icons/utility/down_60.png" alt="Smiley face" height="17" width="17">
