                  ...
                  <article class="slds-post">
                     <header class="slds-post__header slds-media">
                        <div class="slds-media__figure">
                           ...
                           <img alt="Jason Rodgers" src="../../resources/assets/images/avatar1.jpg" title="Jason Rodgers avatar">
                           </a>
                        </div>
                     ...
                     <footer class="slds-post__footer">
                        <ul class="slds-post__footer-actions-list slds-list_horizontal">
                           <li class="slds-col slds-item slds-m-right_medium">
                              ...
                              <img src="../../resources/assets/icons/utility/like_60.png" alt="Smiley face" height="17" width="17"> Like</button>
                           </li>
                           <li class="slds-col slds-item slds-m-right_medium">
                              <button class="slds-button_reset slds-post__footer-action comment_button" title="Comment on this item" id="Comment_box">
                              <img src="../../resources/assets/icons/utility/share_post_60.png" alt="Smiley face" height="17" width="17"> Comment</button>
                           </li>
                           <li class="slds-col slds-item slds-m-right_medium">
                              <button class="slds-button_reset slds-post__footer-action" title="Share this item">
                              <img src="../../resources/assets/icons/utility/internal_share_60.png" alt="Smiley face" height="17" width="17"> Share</button>
                           </li>
                        </ul>
                        ...
                        <li>
                           <article class="slds-comment slds-media slds-hint-parent">
                              <div class="slds-media__figure">
                                 ...
                                 <img alt="Jenna Davis" src="../../resources/assets/images/avatar2.jpg" title="Jenna Davis avatar">
                                 </a>
                              </div>
                              <div class="slds-media__body">
