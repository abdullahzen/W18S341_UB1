         ...
         <div class="slds-scope">
               ...
               <div class="slds-card__header slds-grid">
                  <header class="slds-media slds-media_center slds-has-flexi-truncate">
                     <div class="slds-media__figure">
                        <span class="slds-icon_container slds-icon-action-question-post-action slds-icon_container--circle" title="description of icon when needed">
                           <svg class="slds-icon slds-icon_small" aria-hidden="true">
                              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/action-sprite/svg/symbols.svg#question_post_action" />
                           </svg>
                        </span>
                     </div>
                     ...
                     <form class="form-horizontal">
                        <fieldset>
                           <fieldset class="slds-form-element">
                              <legend class="slds-form-element__legend slds-form-element__label">Select the language</legend>
                                       ...
                                       <span class="slds-visual-picker__figure slds-visual-picker__icon slds-align_absolute-center">
                                          <span class="slds-is-selected">
                                             <span class="slds-icon_container" title="description of icon when needed">
                                                <svg class="slds-icon slds-icon_medium slds-icon-action-check" aria-hidden="true">
                                                   <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/action-sprite/svg/symbols.svg#check" />
                                                </svg>
                                          ...
                                          <span class="slds-is-not-selected">
                                             <span class="slds-icon_container" title="description of icon when needed">
                                                <svg class="slds-icon slds-icon-utility-connected_apps slds-icon_medium slds-icon-text-default" aria-hidden="true">
                                                   <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#connected_apps" />
                                                </svg>
                                                <span class="slds-assistive-text">Provide description of icon</span>
                                             </span>
                                          </span>
                                 ...
                                 <div class="slds-visual-picker slds-visual-picker_small">
                                    ...
                                    <label for="visual-picker-42">
                                       <span class="slds-visual-picker__figure slds-visual-picker__icon slds-align_absolute-center">
                                          ...
                                          <span class="slds-is-not-selected">
                                             <span class="slds-icon_container" title="description of icon when needed">
                                                <svg class="slds-icon slds-icon-utility-desktop_console slds-icon_medium slds-icon-text-default" aria-hidden="true">
                                                   <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#desktop_console" />
                                                </svg>
                                                <span class="slds-assistive-text">Provide description of icon</span>
                                             </span>
                                          </span>
                                 ...
                                 <div class="slds-visual-picker slds-visual-picker_small">
                                    ...
                                    <label for="visual-picker-43">
                                       <span class="slds-visual-picker__figure slds-visual-picker__icon slds-align_absolute-center">
                                          ...
                                          <span class="slds-is-not-selected">
                                             <span class="slds-icon_container" title="description of icon when needed">
                                                <svg class="slds-icon slds-icon-utility-inbox slds-icon_medium slds-icon-text-default" aria-hidden="true">
                                                   <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#inbox" />
                                                </svg>
                                                <span class="slds-assistive-text">Provide description of icon</span>
                                             </span>
                                          </span>
                                 ...
                                 <div class="slds-visual-picker slds-visual-picker_small">
                                    ...
                                    <label for="visual-picker-44">
                                       <span class="slds-visual-picker__figure slds-visual-picker__icon slds-align_absolute-center">
                                          ...
                                          <span class="slds-is-not-selected">
                                             <span class="slds-icon_container" title="description of icon when needed">
                                                <svg class="slds-icon slds-icon-utility-keyboard_dismiss slds-icon_medium slds-icon-text-default" aria-hidden="true">
                                                   <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#keyboard_dismiss" />
                                                </svg>
                                                <span class="slds-assistive-text">Provide description of icon</span>
                                             </span>
                                          </span>
                           ...
                           <div class="slds-form-element">
                              ...
                              <div class="slds-form-element__control">
                                 <textarea id="textarea-id-01" style="width:50%" class="slds-textarea" placeholder="Write your question here...."></textarea>
                              </div>
                           </div>
                           </br>
                           <!-- File Button --> 
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-8">
                                 <button id="button1id" name="button1id" class="slds-button slds-button_brand">Post</button>
                                 <button id="button2id" name="button2id" class="slds-button slds-button_destructive">Reset</button>
                              </div>
                           </div>
                        </fieldset>
                     </form>
            ...
            <div class="slds-page-header">
               <div class="slds-media">
                  ...
                  <div class="slds-media__body">
                     <h1 class="slds-page-header__title slds-truncate slds-align-middle" title="Top Questions">Top Questions</h1>
                     <p class="slds-text-body_small slds-line-height_reset">Top questions are selected based on number of responses / correct answers</p>
                  </div>
               </div>
            </div>
            <ul class="slds-has-dividers_around slds-has-block-links_space">
               <li class="slds-item"><a href="javascript:void(0);">How to select all elements with particular ARIA value using jQuery?</a></li>
               <li class="slds-item"><a href="javascript:void(0);">How do I detect a click outside an element?</a></li>
               <li class="slds-item"><a href="javascript:void(0);">onClickOut (click after leaving the element) [duplicate]</a></li>
            </ul>
            <br/>
            <div class="slds-page-header">
               <div class="slds-media">
                  <div class="slds-media__figure">
                     <span class="slds-icon_container slds-icon-standard-opportunity" title="All Questions">
                        <svg class="slds-icon slds-page-header__icon" aria-hidden="true">
                           <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/standard-sprite/svg/symbols.svg#question_best" />
                        </svg>
                     </span>
                  </div>
                  <div class="slds-media__body">
                     <h1 class="slds-page-header__title slds-truncate slds-align-middle" title="All Questions">All Questions</h1>
                     <p class="slds-text-body_small slds-line-height_reset">Below is the list of all questions segregated by topics</p>
                  </div>
               </div>
            </div>
            <br/>
            <div class="demo-only section" style="width: 320px; background-color: rgb(250, 250, 251);">
               <nav class="slds-nav-vertical slds-nav-vertical_shade" aria-label="Sub page">
                  <div class="slds-nav-vertical__section">
                     ...
                     <ul>
                        <li id="Javali" class="slds-nav-vertical__item slds-is-active"><a href="javascript:void(0);" onclick="showJava();" class="slds-nav-vertical__action" aria-describedby="entity-header" aria-current="page">Java</a></li>
                        <li id="JavaScriptli" class="slds-nav-vertical__item"><a href="javascript:void(0);" onclick="showJavaScript();" class="slds-nav-vertical__action" aria-describedby="entity-header">Javascript</a></li>
                        <li id="Phpli" class="slds-nav-vertical__item"><a href="javascript:void(0);" onclick="showPhp();" class="slds-nav-vertical__action" aria-describedby="entity-header">Php</a></li>
                        <li id="Cli" class="slds-nav-vertical__item"><a href="javascript:void(0);" onclick="showC();" class="slds-nav-vertical__action" aria-describedby="entity-header">C</a></li>
                     </ul>
                  </div>
               </nav>
            </div>
                           ...
                           <li class="slds-feed__item">
                              <article class="slds-post">
                                 ...
                                 <div class="slds-post__content slds-text-longform">
                                    <p>Hey there! <a href="javascript:void(0);" title="Jenna Davis">@Jenna Davis</a>, I've inherited a project I'm working on and I'm updating some jquery animations (very little practice with jquery).
                                          ...
                                          <div class="slds-media__body">
                                             ...
                                             <footer>
                                                <ul class="slds-list_horizontal slds-has-dividers_right slds-text-body_small">
                                                   <li class="slds-item">
                                                      <button class="slds-button_reset slds-text-color_weak" title="Upvote this item" aria-pressed="false">Upvote</button>
                                                   </li>
                                             ...
                                             <ul class="slds-grid">
                                                <li>
                                                   <button class="slds-button slds-button_icon slds-button_icon-container" title="Add User">
                                                      <svg class="slds-button__icon" aria-hidden="true">
                                                         <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#adduser" />
                                                      </svg>
                                                ...
                                                <li>
                                                   <button class="slds-button slds-button_icon slds-button_icon-container" title="Attach a file">
                                                      <svg class="slds-button__icon" aria-hidden="true">
                                                         <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#attach" />
                                                      </svg>
                        ...
                        <ul class="slds-feed__list">
                           <li class="slds-feed__item">
                              <article class="slds-post">
                                 ...
                                 <div class="slds-post__content slds-text-longform">
                                    <p>Hey <a href="javascript:void(0);" title="Jenna Davis">@Jenna Davis</a>, I've inherited a project I'm working on and I'm updating some jquery animations (very little practice with jquery).
                                       I have a div I need to add and remove the style attribute from. Here is the div:
                                    </p>
                                 </div>
                                 <footer class="slds-post__footer">
                              ...
                              <div class="slds-feed__item-comments">
                                 ...
                                 <div class="slds-media slds-comment slds-hint-parent">
                                    ...
                                    <div class="slds-media__body">
                                       <div class="slds-publisher slds-publisher_comment">
                                          <label for="comment-text-input-01" class="slds-assistive-text">Write a answer</label>
                                          <textarea id="comment-text-input-01" class="slds-publisher__input slds-input_bare slds-text-longform" placeholder="Write a answer..."></textarea>
                                          <div class="slds-publisher__actions slds-grid slds-grid_align-spread">
                                             <ul class="slds-grid">
                                                <li>
                                                   <button class="slds-button slds-button_icon slds-button_icon-container" title="Add User">
                           ...
                           <li class="slds-feed__item">
                              <article class="slds-post">
                                 ...
                                 <footer class="slds-post__footer">
                                    <ul class="slds-post__footer-actions-list slds-list_horizontal">
                                       <li class="slds-col slds-item slds-m-right_medium">
                                          <button title="Upvote this item" class="slds-button_reset slds-post__footer-action slds-is-active" aria-pressed="true">
                                             <svg class="slds-icon slds-icon-text-default slds-icon_x-small slds-align-middle" aria-hidden="true">
                                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#share_mobile" />
                                             </svg>
                                             Upvoted
                              ...
                              <div class="slds-feed__item-comments">
                                 <div class="slds-p-horizontal_medium slds-p-vertical_x-small"><a href="javascript:void(0);">You</a> Upvoted this post</div>
                              </div>
                           </li>
                        </ul>
                     </div>
