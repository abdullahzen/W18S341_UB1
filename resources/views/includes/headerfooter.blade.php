                        ...
                        <ul class="slds-global-header__item slds-grid slds-grid_vertical-align-center">
                            ...
                            <li class="slds-dropdown-trigger slds-dropdown-trigger_click">
                                <div class="slds-button-group" role="group">
                                    ...
                                    @if(!session()->has('id'))
                                        <button class="slds-button slds-button_neutral" data-toggle="modal" data-target="#registerModal" id="registerButton">Register</button>
                                        <button class="slds-button slds-button_neutral" data-toggle="modal" data-target="#loginModal" id="loginButton">Login</button>
                                    @endif
                                </div>
                            </li>
                        </ul>
                                            ...
                                            <a href="javascript:void(0);"
                                               class="slds-text-link_reset slds-has-flexi-truncate">
                                                <h3 class="slds-truncate"
                                                    title="Kelly Chan mentioned you in a comment:">
                                                    <strong>Kelly Chan mentioned you in a comment:</strong>
                                                </h3>
                                                <p class="slds-truncate"
                                                   title="I need you to review this for me @Paulina">I need you to
                                                    review this for me @Paulina</p>
