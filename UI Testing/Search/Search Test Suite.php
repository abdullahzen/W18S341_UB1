...
<tr><td>click</td><td>id=global-search-01<datalist><option>id=global-search-01</option><option>//input[@id='global-search-01']</option><option>//input</option><option>css=#global-search-01</option></datalist></td><td></td>
</tr>
<tr><td>type</td><td>id=global-search-01<datalist><option>id=global-search-01</option><option>//input[@id='global-search-01']</option><option>//input</option><option>css=#global-search-01</option></datalist></td><td>Java</td>
</tr>
<tr><td>click</td><td>//header/div<datalist><option>//header/div</option><option>css=div.slds-global-header.slds-grid.slds-grid_align-spread</option></datalist></td><td></td>
</tr>
<tr><td>click</td><td>id=global-search-01<datalist><option>id=global-search-01</option><option>//input[@id='global-search-01']</option><option>//input</option><option>css=#global-search-01</option></datalist></td><td></td>
</tr>
<tr><td>sendKeys</td><td>id=global-search-01<datalist><option>id=global-search-01</option><option>//input[@id='global-search-01']</option><option>//input</option><option>css=#global-search-01</option></datalist></td><td>${KEY_ENTER}</td>
</tr>
<tr><td>type</td><td>id=global-search-01<datalist><option>id=global-search-01</option><option>//input[@id='global-search-01']</option><option>//input</option><option>css=#global-search-01</option></datalist></td><td>Java</td>
</tr>
<tr><td>click</td><td>//div[@id='post']/div[2]<datalist><option>//div[@id='post']/div[2]</option><option>//div[2]/div/div/div[2]</option></datalist></td><td></td>
</tr>
<tr><td>click</td><td>link=Java Test 1<datalist><option>link=Java Test 1</option><option>//a[contains(text(),'Java Test 1')]</option><option>//div[@id='post']/div/div/ul/li/article/header/div[2]/div/p/a</option><option>//a[contains(@href, '/post/1')]</option><option>//p/a</option><option>css=p &gt; a</option></datalist></td><td></td>
</tr>
<tr><td>click</td><td>id=content<datalist><option>id=content</option><option>name=content</option><option>//input[@id='content']</option><option>//form[@id='answerForm']/div/input</option><option>//form/div/input</option><option>css=#content</option></datalist></td><td></td>
</tr>
