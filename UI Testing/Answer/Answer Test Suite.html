...
<head>
	...
	<title>Answer Test Suite</title>
</head>
<body>
<table cellpadding="1" cellspacing="1" border="1">
<thead>
<tr><td rowspan="1" colspan="3">Answer</td></tr>
</thead>
<tbody>
...
<tr><td>click</td><td>link=C Test 1<datalist><option>link=C Test 1</option><option>//a[contains(text(),'C Test 1')]</option><option>//div[@id='C']/div/ul/li/a</option><option>//a[contains(@href, './post/5')]</option><option>//div[20]/div/ul/li/a</option><option>css=#C &gt; div.slds-card &gt; ul.slds-has-dividers_around.slds-has-block-links_space &gt; li.slds-item &gt; a</option></datalist></td><td></td>
</tr>
...
<tr><td>type</td><td>id=content<datalist><option>id=content</option><option>name=content</option><option>//input[@id='content']</option><option>//form[@id='answerForm']/div/input</option><option>//form/div/input</option><option>css=#content</option></datalist></td><td>Yes that is correct. You can solve it by adding a embed tag</td>
</tr>
<tr><td>click</td><td>id=newAnswerButton<datalist><option>id=newAnswerButton</option><option>//input[@id='newAnswerButton']</option><option>//form[@id='answerForm']/div/div/input</option><option>//form/div/div/input</option><option>css=#newAnswerButton</option></datalist></td><td></td>
</tr>
